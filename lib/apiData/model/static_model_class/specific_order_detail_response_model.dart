class Specific_Order_Detail_Response_Model {
  SpecificData? data;
  String? message;
  bool? status;

  Specific_Order_Detail_Response_Model({this.data, this.message, this.status});

  Specific_Order_Detail_Response_Model.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new SpecificData.fromJson(json['data']) : null;
...
class SpecificData {
  ...
  SpecificData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
