class Current_Tailor_Response {
  Data? data;
  String? message;
  bool? status;

  Current_Tailor_Response({this.data, this.message, this.status});

  Current_Tailor_Response.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['Order'] != null) {
      order = <SpecificCustomerOrder>[];
      json['Order'].forEach((v) {
        order!.add(new SpecificCustomerOrder.fromJson(v));
      });
    }
