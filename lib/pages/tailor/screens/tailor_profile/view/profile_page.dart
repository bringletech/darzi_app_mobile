...
class _TailorProfilePageState extends State<TailorProfilePage> {
  ...
  String enterName = "", address = "", profileUrl = "";
  ...
  void userUpdateDetails() {
    setState(() {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        ...
        setState(() {
          isLoading = false;
          enterName = model.data!.name.toString();
          address = model.data!.address.toString();
          profileUrl = model.data!.profileUrl.toString();
          print("name Value is: $enterName");
          print("name Value is: $address");
          print("name value is: $profileUrl");
                                ...
                                GestureDetector(
                                  ...
                                  ClipOval(
                                    ...
                                    onTap: () async {
                                      ...
                                      //var galleryStatus = await Permission.storage.request();
                                      if (cameraStatus.isGranted) {
                                        print("Camera and Gallery permission granted");
                                        _showImageSourceActionSheet(context);
                                      } else {
                                        //openAppSettings();
                                        print("Camera permission denied");
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  SizedBox(width: 8),
                                  AllText(
                                    text: AppLocalizations.of(context)!.userAddress,
                                    fontFamily: 'Poppins',
                                    fontSize: 18,
                                    fontWeight: FontWeight.w500,
                                  ),
        ...
        return GestureDetector(
          onTap: () async {
            if(_selectedImage!= null){
              ...
              Uri url = Uri.parse('$apiImageBaseUrl/tailor/updateTailorDetails');
              print("Url is $url");
              ...
              print("Access Token is $accessToken");
            //  Uri url = Uri.parse('$apiImageBaseUrl/tailor/updateTailorDetails');
              Uri url = Uri.parse('$apiBaseUrl/tailor/updateTailorDetails');
              print("Url is $url");
              var request = http.MultipartRequest('PUT', url);
              request.headers['accept'] = "application/json";
              request.headers['Authorization'] = "Bearer $accessToken";
  ...
  void showAlertDialog(BuildContext context, {required Locale locale, required Function(Locale) onChangeLanguage}) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
                  ...
                  child: Card(
                    ...
                    child: TextButton(
                      onPressed: () async {
                        ...
                        // Navigate to HomePage and pass the onChangeLanguage function
                        // Navigator.pushReplacement(
                        //   context,
                        //   MaterialPageRoute(
                        //     builder: (context) => HomePage(onChangeLanguage: (locale) {
                        //       // Provide logic for language change if required
                        //     }),
                        //   ),
                        // );
                        ...
                        //   MaterialPageRoute(
                        //     builder: (context) => HomePage(onChangeLanguage: onChangeLanguage),
                        //   ),
                        ...
                        // await prefs.clear();
                        //
                        // // Add a short delay for better UX if needed
