...
class _AddCustomerState extends State<AddCustomer> {
 ...
 final ImagePicker _picker = ImagePicker();
  ...
  void calculateOutstandingBalance() {
    ...
    double advance = double.tryParse(advancedReceivedController.text) ?? 0.0;
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () {
                          if (nameController.text.isEmpty ||
                              ...
                              bustController.text.isEmpty ||
                              underBustController.text.isEmpty ||
                              waistController.text.isEmpty ||
                              hipsController.text.isEmpty ||
                              neckToAboveKneeController.text.isEmpty ||
                              armLengthController.text.isEmpty ||
                              shoulderSeamController.text.isEmpty ||
                              armHoleController.text.isEmpty ||
                              bicepController.text.isEmpty ||
                              foreArmController.text.isEmpty ||
                              wristController.text.isEmpty ||
                              shoulderToWaistController.text.isEmpty ||
                              bottomLengthController.text.isEmpty ||
                              ankleController.text.isEmpty ||
                              stitchingCostController.text.isEmpty ||
                              advancedReceivedController.text.isEmpty ||
                              outStandingBalanceController.text.isEmpty) {
  ...
  Future<void> addCustomerMethod() async {
    ...
    request.fields["advanceReceived"] =
        advancedReceivedController.text.toString();
