...
class _MeasurementsScreenState extends State<MeasurementsScreen> {
  ...
  String name = "",mobileNumber = "",optional = "", neck = "",bust = "",underBust = "",waist = "",
      ...
      bicep1 = "", foreArm1 = "", wrist1 = "", ankle1 = "",shoulderToWaist1 = "",bottomLength1 = "",message = "";
    ...
    return Scaffold(
      appBar: CustomAppBarWithBack(
          onBackButtonPressed:() async {
            ...
            // final result = await Navigator.push(widget.context, MaterialPageRoute(builder: (context) => TailorDashboardNew()),);
            // if(result == true){
            //   setState(() {
            //     _isRefreshed = true;
            //   });
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      // onTap: (){
                      //   neck = neckController.text.toString();
                      //   bust = bustController.text.toString();
                      //   underBust = underBustController.text.toString();
                      //   waist = waistController.text.toString();
                      //   hips = hipsController.text.toString();
                      //   neckToAboveKnee = neckToAboveKneeController.text.toString();
                      //   armLength = armLengthController.text.toString();
                      //   shoulderSeam = shoulderSeamController.text.toString();
                      //   armHole = armHoleController.text.toString();
                      //   bicep = bicepController.text.toString();
                      //   foreArm = foreArmController.text.toString();
                      //   wrist = wristController.text.toString();
                      //   shoulderToWaist = shoulderToWaistController.text.toString();
                      //   bottomLength = bottomLengthController.text.toString();
                      //   ankle = ankleController.text.toString();
                      //   neck = neck.replaceAll(RegExp(optional), '');
                      //   bust = bust.replaceAll(RegExp(optional), '');
                      //   underBust = underBust.replaceAll(RegExp(optional), '');
                      //   waist = waist.replaceAll(RegExp(optional), '');
                      //   hips = hips.replaceAll(RegExp(optional), '');
                      //   neckToAboveKnee = neckToAboveKnee.replaceAll(RegExp(optional), '');
                      //   armLength = armLength.replaceAll(RegExp(optional), '');
                      //   shoulderSeam = shoulderSeam.replaceAll(RegExp(optional), '');
                      //   armHole = armHole.replaceAll(RegExp(optional), '');
                      //   bicep = bicep.replaceAll(RegExp(optional), '');
                      //   foreArm = foreArm.replaceAll(RegExp(optional), '');
                      //   wrist = wrist.replaceAll(RegExp(optional), '');
                      //   shoulderToWaist = shoulderToWaist.replaceAll(RegExp(optional), '');
                      //   bottomLength = bottomLength.replaceAll(RegExp(optional), '');
                      //   ankle = ankle.replaceAll(RegExp(optional), '');
                      //   updateMeasurementData(widget.customerId.toString(),neck,bust,underBust,waist,
                      //       hips,neckToAboveKnee,armLength,shoulderSeam,armHole,bicep,foreArm,
                      //       wrist,shoulderSeam,bottomLength,ankle);
                      // },
                      onTap: () {
                        if ([
                          neckController,
  ...
  Future<void> updateMeasurementData(String customerId, String name, String mobileNo,String neck,String bust,String underBust, String waist,String hips,
      String neckToAboveKnee,String armLength,String shoulderSeam,String armHole,
      String bicep,String foreArm, String wrist,String shoulderToWaist,String bottomLength,String ankle) async {
    var map = Map<String, dynamic>();
  ...
  void updateMeasurementDetails() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        ...
        // neckController.text = "${neck} $optional";
        // bustController.text = "${bust} $optional";
        // underBustController.text = "${underBust} $optional";
        // bicepController.text = "${bicep} $optional";
        // armHoleController.text = "${armHole} $optional";
        // armLengthController.text = "${armLength} $optional";
        // waistController.text = "${waist} $optional";
        // wristController.text = "${wrist} $optional";
        // ankleController.text = "${ankle} $optional";
        // shoulderToWaistController.text = "${shoulderToWaist} $optional";
        // shoulderSeamController.text = "${shoulderSeam} $optional";
        // foreArmController.text = "${foreArm} $optional";
        // bottomLengthController.text = "${bottomLength} $optional";
        // neckToAboveKneeController.text = "${neckToAboveKnee} $optional";
        // hipsController.text = "${hips} $optional";
