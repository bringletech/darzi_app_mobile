...
import '../../../../../apiData/model/static_model_class/specific_order_detail_response_model.dart';
import '../../../../../colors.dart';
    ...
    return Scaffold(
      appBar: CustomAppBarWithBack(
        ...
        onBackButtonPressed: (){
          ...
          //   MaterialPageRoute(
          //       builder: (context) => oldDress(widget.customerId,context,widget.locale)),
          // );
          Navigator.pop(context, true); // Pass a flag (e.g., true) to indicate refresh is needed
        },
      ),
      body: isLoading
          ? Center(
